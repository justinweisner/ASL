...
!function() {
    ...
    var a = {
        ...
        k = function(a) {
            var b = jQuery;
            return b.fn.overlay = a, function(a) {
                a = b.extend({
                    interval: 1e3,
                    skip: ":not(*)",
                    start: function() {
                ...
                generateHtml: function() {
                    ...
                    for (this.$element.html(this.$element.find(".pt-part").eq(0).html()), c = this.$element.html(), this.$element.children(".pt-part").remove(), b = 0; b < this.rows; b++)
                        for (a = 0; a < this.cols; a++)
                            this.$element.append('<div class="pt-part pt-perspective" data-col-no="' + a + '" data-row-no="' + b + '" style="position: absolute;"></div>').children(":last-child").html(c).find(".pt-item");
        ...
        v = function(a, b, c, d, e, f, g, h) {
            ...
            return k.prototype = {
                ...
                refreshSize: function() {
                    this.thumbnails.isFullScreen() || (this.refreshContainerSize(), "original" === this.jGallery.options.zoomSize ? this.original() : "fill" === this.jGallery.options.zoomSize ? this.fill() : this.fit(), this.jGallery.options.draggableZoom && (this.refreshDragNavCropSize(), this.refreshDragNavVisibility()), this.$element.addClass("visible"))
                },
                refreshDragNavCropSize: function() {
                    var a,
                        b,
                        c = this.$element.find("img.active");
                ...
                changeSize: function() {
                    if ("fit" === this.jGallery.options.zoomSize)
                        ...
                        "original" === this.jGallery.options.zoomSize && (this.jGallery.options.zoomSize = "fit");
                ...
                showPhotoSuccess: function(a, b, d) {
                    var e,
                        f = this.$element.find("img.active");
                    d = i.extend({}, {
                        historyPushState: !0
                        ...
                        f.options.browserHistory && f.browserHistory(), f.options.autostart && f.autostart(), e(), q.on({
                            keydown: function(a) {
                                if (f.$element.is(":visible")) {
                                    if (27 === a.which) {
                                        if (a.preventDefault(), f.thumbnails.getElement().is(".full-screen"))
                                            return f.thumbnails.changeViewToBar(), void f.zoom.refreshSize();
                                        f.hide()
                                    }
                ...
                browserHistory: function() {
                    function a() {
                        ...
                        if (document.location.hash)
                            switch (a = document.location.hash.replace("#", "")) {
                            case "":
                                b.hide({
                                    historyPushState: !1
                                });
